  ...
  return (
    <div className="sale-form">
      ...
      <form className="form">
        ...
        <br></br>
        <input type="number" placeholder="ChangeAmount" className="input" onChange={inputHandler}></input>
        <br></br>
        <input type="number" className="input" readOnly="true" value={Number(result).toFixed(2)}></input>
      </form>
    </div>
  );
}
